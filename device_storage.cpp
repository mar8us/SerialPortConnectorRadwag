...
bool DeviceStorage::saveToFile(const QList<const Device*>& devices)
{
...
QList<const Device*> DeviceStorage::loadFromFile()
{
    QFile file(getStoragePath());
    ...
    for(const auto& value : jsonArray)
    {
        ...
        const Device* device = new Device(name, baudRate, dataBits, parity, stopBits, commands);
